...
#########################
                sj_prob_dict={};
                for i in range(0,len(variables[variable])):
                    sj_prob_dict[variables[variable][i]]=1
                # dist[(variable,"")]=[([],sj_prob_dict)]
                dist[(variable,"")]={}
                dist[(variable,"")][()] = [dict(sj_prob_dict),len(variables[variable])]
#########################
                infile.readline()  # }
                ...
                if match:
                    ...
                    sj_prob_dict2={};
                    for i in range(0,len(variables[variable])):
                        sj_prob_dict2[variables[variable][i]]=1
                    dist[(variable,given)] = {}
                    #####################
                    ...
                    while True:
                        ...
                        #######################################
                        dist[(variable,given)][tuple(given_values)] = [dict(sj_prob_dict2),len(variables[variable])]
                        #######################################
...
"""
    ...
    outfile.close()
    return (variables,dist)

# (var,dis) = parse("A3_data/andes")
# print dis